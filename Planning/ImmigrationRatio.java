...
public class ImmigrationRatio {
	...
	public static class MapClass extends Mapper<LongWritable, Text, Text, Text> {
		...
		public void map(LongWritable key, Text value, Context context)throws IOException, InterruptedException {
				...
				context.write(new Text("null"), new Text(cob+","+weekswork+","+citz));
	...
	public static class ReduceClass extends Reducer<Text, Text, Text, Text> {
		public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
			...
			for (Text val : values) {
				...
				if((!citizenship.contains(" Native- Born in the United States"))&&(!citizenship.contains(" Foreign born- U S citizen by naturalization")))
				{
					foreigner++;
			...
			String citizentoimmigration = " No. of Citizen Employers : No. of Foreign Employers              "+citizenworkers+" : "+foreignworkers;
