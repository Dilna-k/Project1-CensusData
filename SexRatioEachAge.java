...
import SexRatioAgeGroup.SexRatioEachAge;
import SexRatioAgeGroup.SexRatioEachAge.MapClass;
import SexRatioAgeGroup.SexRatioEachAge.ReduceClass;
...
public static class ReduceClass extends Reducer<Text, Text, NullWritable, Text>	
{
	public void reduce (Text key,Iterable<Text> values,Context context)throws IOException, InterruptedException 
	{
		...
		String a="Sex Ratio of Infants (0 to 12) male:female "+male1+":"+female1;
		String b="Sex Ratio of Teenegers (13 to 17) male:female "+male2+":"+female2;
		String c="Sex Ratio of Adults (18 to 40) male:female "+male3+":"+female3;
		String d="Sex Ratio of Middle Aged (41 to 60) male:female "+male4+":"+female4;
		String e="Sex Ratio of Seniors (61 to 80) male:female "+male5+":"+female5;
		String f="Sex Ratio of Elderly (81 to 100) male:female "+male6+":"+female6;
