...
public class TotalScholarship2 {
	...
	public static class MapClass extends Mapper<LongWritable, Text, Text, Text> {
		...
		public void map(LongWritable key, Text value, Context context)throws IOException, InterruptedException {
			...
			//without x value
				...
				if(par.contains("Neither parent present")||(par.contains(" Not in universe")))
				{
	...
	public static class ReduceClass extends Reducer<Text, Text, Text, Text> {
		public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
			...
			String ScholarshipAmt1 = " Total Scholarship for : "+count1 +" Infants(0 to 12) Amount is "+p1+" Total amount "+(count1*p1);
			String ScholarshipAmt2 = " Total Scholarship for : "+count2 +" Teenagers(13 to 17) Amount is "+p2+" Total amount "+(count2*p2);
